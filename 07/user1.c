...
static const char *g_send_queue = QUEUE_NAME_1_2;
static const char *g_receive_queue = QUEUE_NAME_2_1;
...
void print_help() {
    ...
    printf("  Любое другое сообщение будет отправлено Пользователю 2\n");
    printf("============================\n\n");
}
...
int main() {
    ...
    printf("Инициализация чата для Пользователя 1...\n"); 
    ...
    print_help();
    printf("[Напишите первое сообщение]: ");
    fflush(stdout);
